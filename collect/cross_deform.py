'''this file is cross deform data collection final version 
   if you want to collect data in a single thread ,you can use this file
   otherwise please excute cross_deform_start which excute this file in multi-thread
'''
