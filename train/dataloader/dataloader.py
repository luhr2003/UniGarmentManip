...
if __name__=="__main__":
    config=Config()
    dataset=averDataset(deform_path="/home/luhr/correspondence/softgym_cloth/trousers_train_data",object_path="/home/luhr/correspondence/softgym_cloth/garmentgym/trousers",config=config,flag="train")
    for i in range(100):
        pc1_t,pc2_t,corr_t=dataset[i]
        pc1_t[:,0]-=1
        pc2_t[:,0]+=1
