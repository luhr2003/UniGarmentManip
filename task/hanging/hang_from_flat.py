...
from garmentgym.garmentgym.env.hang import HangEnv
import open3d as o3d
import torch.nn.functional as F
import pyflex
from typing import List
from hang_start import Task_result
...
if __name__=="__main__":
    ...
    parser=argparse.ArgumentParser()
    parser.add_argument('--demonstration',type=str,default='/home/luhr/correspondence/softgym_cloth/demonstration/hang_trajectory/single/00044')
    ...
    # load flat cloth
    env=HangEnv(current_cloth,store_path=store_dir,id=mesh_id)
    for j in range(50):
        pyflex.step()
        pyflex.render()
