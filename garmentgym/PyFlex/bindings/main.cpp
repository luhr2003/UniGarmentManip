          ...
          bool centerCamera = true, int thread_idx = 0)
{
    ...
    // create scene
    StartGpuWork();
    g_scenes[g_scene]->Initialize_clothes(
...
void Init_Empty(int scene, py::dict scene_params)
{
    ...
    StartGpuWork();
    //    cout<<thread_idx<<endl;
    g_scenes[g_scene]->Initialize_empty(scene_params);
    EndGpuWork();
