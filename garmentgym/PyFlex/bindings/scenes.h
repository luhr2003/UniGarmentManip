...
public:
	...
	virtual void Initialize_clothes(py::array_t<float> scene_params, 
				...
				int thread_idx = 0){};
	virtual void Initialize_empty(py::dict scene_paramss){};
...
#include "softgym_scenes/softgym_clothes.h"
#include "softgym_scenes/empty_scene.h"
